...
var player,pimg,wall,b = [],j = 1,k=1;
...
pimg = loadAnimation("spriteone.png","spritetwo.png")
...
function setup() {
 ...
 if(i<=16){
    ...
    b[i].shapeColor = "yellow"
 }
    else if(i>16&&i<=30){
      
     
    b[i]=createSprite(575, 100+(20*j), 15, 15);
    b[i].shapeColor = "yellow"
    j++
  }
  else{
b[i]= createSprite(175,30+(20*k),15,15)
b[i].shapeColor = "yellow"
k++
  }
  ...
  side2 = createSprite(300,200,5,100);
   ...
   enemy3 = createSprite(400,90,100,20,20)
...
text("Save Food and Use it Judiciously",50,200)
}
